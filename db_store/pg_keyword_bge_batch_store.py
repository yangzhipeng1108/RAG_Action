...
cur.execute(
    'CREATE TABLE subkeyword (id bigserial PRIMARY KEY,title text , title_embedding vector(1024),keyword text,keyword_embedding vector(1024))')
...
# 构造INSERT语句
insert_query = "INSERT INTO subkeyword (title,title_embedding,keyword, keyword_embedding)  VALUES %s"
...
cur.execute(
    'CREATE TABLE keywords (id bigserial PRIMARY KEY,title text , title_embedding vector(1024), keyword text, keyword_embedding vector(1024))')
...
# 构造INSERT语句
insert_document_query = "INSERT INTO keywords (title,title_embedding,keyword, keyword_embedding)  VALUES %s"
